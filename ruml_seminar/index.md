...
- 25/4/2023 at 3.30pm **in person**: [Daniel Springer](https://www.iarai.ac.at/people/daniel/) (IARAI) _A Machine Learning Approach to the Analytic Continuation Problem_  
...
- 30/5/2023 at 2pm: [Tiffany Vlaar](https://tiffanyvlaar.github.io/) (Mila and McGill University) _Constrained and Multirate Training of Neural Networks_  
...
- 6/6/2023 **in person**: [Viacheslav Borovitskiy](https://vab.im/) (ETH Zürich) _Geometric Gaussian Processes_  
...
- [Laurens Devos](https://people.cs.kuleuven.be/~laurens.devos/), [Linara Adilova](https://informatik.rub.de/ml/personen/adilova/) (Uni Bochum), and {{ site.data.people.MichaelKamp }} (Uni Bochum) at our Post-IJCAI-ML workshop (30/7/2022, 11.30am-5pm, **in person**) 
...
- [Pascal Welke](https://mlai.cs.uni-bonn.de/people/pascal-welke) (Uni Bonn) _A Generalized Weisfeiler-Lehman Graph Kernel_ (15/3/2022, 2pm, **in person**)  
...
- {{ site.data.people.DanielPaurat }} (Telekom) _Machine Learning @ Telekom_ (2/3/2021, 2pm)
...
-  {{ site.data.people.DinoOglic }} (King's College London) on _Parznets -- Deep CNNs for Waveform-based Speech Recognition_ (10/11/2020, 2pm)  
...
-  {{ site.data.people.MichaelKamp }} (Monash University, Melbourne) on _Black-Box Machine Learning_ (1/9/2020, 1pm)
